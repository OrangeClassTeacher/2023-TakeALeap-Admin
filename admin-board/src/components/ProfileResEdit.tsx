                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="p-6 space-y-6" >
                            <div className='flex flex-col'>
                                ...
                                <input value={resData?.restaurantName} onChange={(e) => setResData({ ...resData, restaurantName: e.target.value })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="" className='text-gray-900 text-sm text-white'>Email:</label>
                                <input value={resData?.email} onChange={(e) => setResData({ ...resData, email: e.target.value })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="" className='text-gray-900 text-sm text-white'>Description:</label>
                                <input value={resData?.description} onChange={(e) => setResData({ ...resData, description: e.target.value })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <input value={resData?.address?.street} onChange={(e) => setResData({ ...resData, address: { ...resData.address, street: e.target.value } })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="" className='text-gray-900 text-sm text-white'>Address:</label>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <input value={resData?.contact?.phone} onChange={(e) => setResData({ ...resData, contact: { ...resData.contact, phone: e.target.value } })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="" className='text-gray-900 text-sm text-white'>Facebook:</label>
                                <input value={resData?.contact?.facebook} onChange={(e) => setResData({ ...resData, contact: { ...resData.contact, facebook: e.target.value } })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="" className='text-gray-900 text-sm text-white'>Instagram:</label>
                                <input value={resData?.contact?.Instagram} onChange={(e) => setResData({ ...resData, contact: { ...resData.contact, Instagram: e.target.value } })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="" className='text-gray-900 text-sm text-white'>Page link:</label>
                                <input value={resData?.contact?.link} onChange={(e) => setResData({ ...resData, contact: { ...resData.contact, link: e.target.value } })} type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                            </div>
                            <div className='flex flex-col'>
